...
const audienceImage = "/images/sections/business-dev.png";
          ...
          {audienceCards.map((audience) => {
            ...
            return (
              <motion.div key={audience.title} variants={fadeInUp}>
                <GlassCard tone={audience.tone ?? "green"} className="h-full md:min-h-[245px] hover:-translate-y-1.5 hover:border-tree-green/40 hover:shadow-[0_12px_32px_rgba(74,222,128,0.1)]">
